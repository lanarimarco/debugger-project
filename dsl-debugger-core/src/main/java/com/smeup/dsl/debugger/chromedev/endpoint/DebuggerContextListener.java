...
import com.smeup.dsl.debugger.chromedev.Consts;
import com.smeup.dsl.debugger.chromedev.DebuggeeInstancesFactory;
...
public class DebuggerContextListener implements ServletContextListener{
    ...
    public void contextInitialized(ServletContextEvent sce) {
        LOGGER.log(Level.INFO, "Initializing DebuggeeInstancesFactory");
